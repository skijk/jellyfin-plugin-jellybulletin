...
public static partial class WebInjection
{
    public static async Task TransformIndex(string path, Stream stream)
    {
        ...
        const string assets = """
            <link data-jellyfin-bulletin rel="stylesheet" href="/Bulletin/Client.css?v=0.4.1.0">
            <script data-jellyfin-bulletin defer src="/Bulletin/Client.js?v=0.4.1.0"></script>
            """;
